...
describe(`API > Accounts`, () => {
  ...
  it(`[C36507] Create account for old corporate with Standard limits @smoke`, async () => {
    allureReporter.addSeverity('critical');
    allureReporter.addFeature('API Accounts');
    allureReporter.addTestId('https://centtrip.testrail.io/index.php?/cases/view/36507');
    ...
    expect(cardLimit).toEqual('Standard');
    ...
    expect(getGroupLimitsRequest.body.transactionRules[0].ruleRestrictions.totalAmount.value.value).toEqual(3000000);
    expect(getGroupLimitsRequest.body.transactionRules[1].ruleRestrictions.totalAmount.value.value).toEqual(15000000);
    expect(getGroupLimitsRequest.body.transactionRules[2].ruleRestrictions.totalAmount.value.value).toEqual(300000);
    expect(getGroupLimitsRequest.body.transactionRules[3].ruleRestrictions.totalAmount.value.value).toEqual(15000000);
    expect(getGroupLimitsRequest.body.transactionRules[4].ruleRestrictions.totalAmount.value.value).toEqual(75000000);
  ...
  it(`[C36510] Create account for old corporate with Increased limits`, async () => {
    allureReporter.addSeverity('critical');
    allureReporter.addFeature('API Accounts');
    allureReporter.addTestId('https://centtrip.testrail.io/index.php?/cases/view/36510');
    ...
    const accountLimits = await commonPageUSA.checkAccountLimitInDB('761a7ec2-e9fe-4538-8266-4dae30305b2d');
    expect(accountLimits[0][0]).not.toBe(null);
    expect(accountLimits[0][3]).not.toBe(null);
    ...
    expect(getGroupLimitsRequest.status).toBe(200);
    expect(Object.keys(getGroupLimitsRequest.body)).toEqual(['transactionRules']);
    // console.log('This is arr - ', getGroupLimitsRequest.body.transactionRules);
    // const rules = getGroupLimitsRequest.body.transactionRules
    const amounts = getGroupLimitsRequest.body.transactionRules.map(rule => rule.ruleRestrictions.totalAmount.value.value);
    expect(amounts.sort(function(a, b){return a - b})).toEqual([500000, 5000000, 25000000, 27500000, 100000000]);
    console.log('this is amounts - ', amounts);
    // expect(getGroupLimitsRequest.body.transactionRules[0].ruleRestrictions.totalAmount.value.value).toEqual(27500000);
    // expect(getGroupLimitsRequest.body.transactionRules[1].ruleRestrictions.totalAmount.value.value).toEqual(100000000);
    // expect(getGroupLimitsRequest.body.transactionRules[2].ruleRestrictions.totalAmount.value.value).toEqual(5000000);
    // expect(getGroupLimitsRequest.body.transactionRules[3].ruleRestrictions.totalAmount.value.value).toEqual(25000000);
    // expect(getGroupLimitsRequest.body.transactionRules[4].ruleRestrictions.totalAmount.value.value).toEqual(500000);

    const getTransactionRuleLimitFirst = await HttpMethods.get(apiEndpoints.getTransactionRuleData(accountLimits[0][3]),
      requestHeadersAdyen, URLs.apiAdyenUrl);
    expect(getTransactionRuleLimitFirst.status).toBe(200);
    expect(getTransactionRuleLimitFirst.body.transactionRule.ruleRestrictions.totalAmount.value.value).toEqual(27500000);

    const getTransactionRuleLimitsecond = await HttpMethods.get(apiEndpoints.getTransactionRuleData(accountLimits[1][3]),
      requestHeadersAdyen, URLs.apiAdyenUrl);
    expect(getTransactionRuleLimitsecond.status).toBe(200);
    expect(getTransactionRuleLimitsecond.body.transactionRule.ruleRestrictions.totalAmount.value.value).toEqual(100000000);

    const getTransactionRuleLimitThird = await HttpMethods.get(apiEndpoints.getTransactionRuleData(accountLimits[2][3]),
      requestHeadersAdyen, URLs.apiAdyenUrl);
    expect(getTransactionRuleLimitThird.status).toBe(200);
    expect(getTransactionRuleLimitThird.body.transactionRule.ruleRestrictions.totalAmount.value.value).toEqual(25000000);

    const getTransactionRuleLimitFourth = await HttpMethods.get(apiEndpoints.getTransactionRuleData(accountLimits[3][3]),
      requestHeadersAdyen, URLs.apiAdyenUrl);
    expect(getTransactionRuleLimitFourth.status).toBe(200);
    expect(getTransactionRuleLimitFourth.body.transactionRule.ruleRestrictions.totalAmount.value.value).toEqual(500000);

    const getTransactionRuleLimitFiveth = await HttpMethods.get(apiEndpoints.getTransactionRuleData(accountLimits[4][3]),
      requestHeadersAdyen, URLs.apiAdyenUrl);
    expect(getTransactionRuleLimitFiveth.status).toBe(200);
    expect(getTransactionRuleLimitFiveth.body.transactionRule.ruleRestrictions.totalAmount.value.value).toEqual(5000000);
  });

  it(`[C36511/1] Update account limits for old corporate - primary account @smoke`, async () => {
    allureReporter.addSeverity('critical');
    allureReporter.addFeature('API Accounts');
    allureReporter.addTestId('https://centtrip.testrail.io/index.php?/cases/view/36511');
    const guid = uuidv4();
  ...
  it(`[C36509] Account details: primary account @smoke`, async () => {
    allureReporter.addSeverity('critical');
    allureReporter.addFeature('API Accounts');
    allureReporter.addTestId('https://centtrip.testrail.io/index.php?/cases/view/36509');
  ...
  it(`[C36516] Account details: card account @smoke`, async () => {
    allureReporter.addSeverity('critical');
    allureReporter.addFeature('API Accounts');
    allureReporter.addTestId('https://centtrip.testrail.io/index.php?/cases/view/36516');
  ...
  it(`[C36514] Accounts list: not primary account @smoke`, async () => {
    allureReporter.addSeverity('critical');
    allureReporter.addFeature('API Accounts');
    allureReporter.addTestId('https://centtrip.testrail.io/index.php?/cases/view/36514');
